...
<input type="password" onfocus="emptyElement('status')" style="width:350px;font:20px Georgia; color:#383838; height:40px; padding:10px"  id="password" maxlength="100"><br /><br /></td></tr>
    ...
    <div id="registerbt"><center><div style="min-height:15px;"></div>
        <a href="register.php" style="" class="button">Create a FREE account</a>
        </center>
    </div>
</td></tr>
</table>
